...
<p>&nbsp;</p>
	   ...
	   <% 
	   String query1=" select * from seachitem where keyword='"+filename+"'";
...
ResultSet rs1 = ps1.executeQuery();
	   ...
	   if(!(rs1.next()))
	   {    
     query1=" select  max(id) from seachitem";
	// out.print(query1);
       ...
       if(rs2.next())
       {
			...
			maxid++;
			query1=" insert into seachitem(id,keyword,count) values('"+maxid+"','"+filename+"','0')";
