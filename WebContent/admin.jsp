...
<center>
 ...
 <%
        			...
        			if(dd==null){
        				...
        				<center><font size="5" color="red">Login Faild </font></center>
						<%
        			}
        		%>
...
<p>&nbsp;</p> <center><h1>Admin Login</h1></center>
	   <form action="admin1.jsp" method="get" >
         <table class="table5"><tr><td>
              ...
              </td><td>  <input type="text" name="password"  placeholder="Password"  class="field-long" required/>
          </tr><tr> <td></td>  <td> 
     
                     <input name="reset" type="reset" value="Clear" />   <input name="submit" type="submit" value="Submit" />
   </td> </tr>
           </table>
